...
export const ourSpecsData = [
    { title: "1-2 Year Warranty", description: "Every drive and device is covered by a 1 to 2 year warranty for complete peace of mind.", icon: ShieldCheckIcon, accent: '#05DF72' },
    { title: "Onsite Physical and Health Check", description: "Free onsite physical inspection and drive health check before and after every purchase.", icon: HeartPulseIcon, accent: '#FF8904' },
    { title: "24/7 Support", description: "Our team is available round the clock for warranty claims, technical help and queries.", icon: HeadsetIcon, accent: '#A684FF' }
]
...
const orderDummyProducts = [
    { id: "prod_1", name: "Table Lamp", images: [product_img1] },
    { id: "prod_2", name: "Bluetooth Speakers", images: [product_img2] },
    { id: "prod_3", name: "Smart Watch", images: [product_img3] },
    { id: "prod_4", name: "Wireless Headphones", images: [product_img4] },
    { id: "prod_5", name: "Smart Watch Pro", images: [product_img5] },
]
...
export const orderDummyData = [
    {
        ...
        orderItems: [
            { orderId: "cmemm75h5001jtat89016h1p3", productId: "cmemlydnx0017tat8h3rg92hz", quantity: 1, price: 89, product: orderDummyProducts[0], },
            { orderId: "cmemm75h5001jtat89016h1p3", productId: "cmemlxgnk0015tat84qm8si5v", quantity: 1, price: 149, product: orderDummyProducts[1], }
        ],
    ...
    },
    {
        ...
        orderItems: [
            { orderId: "cmemm6jv7001htat8vmm3gxaf", productId: "cmemm1f3y001dtat8liccisar", quantity: 1, price: 229, product: orderDummyProducts[2], },
            { orderId: "cmemm6jv7001htat8vmm3gxaf", productId: "cmemm0nh2001btat8glfvhry1", quantity: 1, price: 99, product: orderDummyProducts[3], },
            { orderId: "cmemm6jv7001htat8vmm3gxaf", productId: "cmemlz8640019tat8kz7emqca", quantity: 1, price: 199, product: orderDummyProducts[4], }
        ],
        address: addressDummyData,
        user: dummyUserData
    }
